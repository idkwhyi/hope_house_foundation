...
const HomeEducationCrisis = () => {
  useSmoothReveal();
  return (
    <section className="relative w-full bg-[#E1EAE6] h-full p-[3.2rem] py-[6.4rem] lg:p-[6.4rem] flex flex-col items-start justify-between gap-10 ">
      ...
      <div className="w-full h-max flex flex-col lg:flex-row gap-[3.2rem] lg:gap-[8rem] py-[3.2rem] lg:py-[6.4rem] items-center">
        ...
        {/* content 1 container */}
        <div className=" w-full flex flex-col items-center justify-between text-[1.8rem] gap-[.2rem]">
          <h3
            data-smooth-reveal
            className="merri-bold text-[3.2rem] lg:text-[4.8rem]"
          >
          ...
          <div className="w-full flex items-start py-[2.3rem] lg:py-0 lg:items-center justify-start gap-[6.4rem] text-[1.6rem] jakarta-regular">
            <div data-smooth-reveal className="w-fit flex flex-col">
              <h4 className="jakarta-bold text-[3.2rem] lg:text-[4.8rem]">
                4.1 Million
              </h4>
              <p>Not in school</p>
            </div>
          ...
          <div className="w-full flex items-center gap-[2.4rem]">
            {/* BUTTON CONTAINER */}
            <ButtonBorderNoBg
              link="https://www.unicef.org/indonesia/education-and-adolescents"
              text="Read Articles"
            />
      ...
      <div className="w-full h-max flex flex-col lg:flex-row gap-[3.2rem] lg:gap-[8rem] py-[3.2rem] lg:py-[6.4rem] items-center">
        {/* content 2 container */}
        <div className="relative lg:hidden lg:min-w-[43.5rem] w-full lg:w-[43.5rem] h-[30rem] lg:h-[70vh] rounded-lg px-[3.2rem]">
          <Image
        ...
        <div className="w-full flex flex-col items-center justify-between text-[1.8rem] gap-[.2rem]">
          ...
          <h3
            data-smooth-reveal
            className="merri-bold text-[3.2rem] lg:text-[4.8rem] w-full"
          >
            Education Inequality Crisis.
          </h3>

          <p data-smooth-reveal className="">
            The economy is the main factor in the high dropout rate. The impact
            of the COVID-19 pandemic has worsened this condition, forcing many
            children to work to help the family economy.
          </p>
          ...
          <div className="w-full flex items-center gap-[2.4rem]">
            {/* BUTTON CONTAINER */}
            <ButtonBorderNoBg
              link="https://kumparan.com/setyo-purwoto/putus-sekolah-dampak-dari-buruknya-ekonomi-indonesia-22QYrofaPF0/3"
              text="Read Articles"
              color="black"
            />
            <ButtonWithArrow link="/donation" text="Donate Now" />
        ...
        {/* image container */}
        <div className="hidden relative lg:block lg:min-w-[43.5rem] w-full lg:w-[43.5rem] h-[30rem] lg:h-[70vh] rounded-lg px-[3.2rem]">
          {" "}
          {/* Tambahkan hidden dan lg:block */}
          <Image
            src={"/images/edu_crisis2.png"}
            alt="education crisis image 1"
            fill
